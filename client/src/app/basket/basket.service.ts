...
export class BasketService {
  ...
  private basketTotalService = new BehaviorSubject<BasketTotals | null>(null);
  basketTotalSource$ = this.basketTotalService.asObservable();
  ...
  private calculateTotals() {
    ...
    this.basketTotalService.next({shipping: basket.shippingPrice, total, subtotal});
  }
